...
Contributors: Microcodice
Tags: shortcode, gutenberg, block, custom, padding, margin, background color
...
== Screenshots ==
1. The Custom Shortcode Block in the Gutenberg editor.
2. Customizing padding and margin in the block settings.
3. Example of a shortcode with custom styling applied.
...
== Upgrade Notice ==
= 1.0.0 =
Initial release of the plugin. No upgrades available yet.
